 ...
 item_img_large = imageUrlLarge;
  ...
  var maxCharacters = 160; // Define the maximum number of characters
   ...
   if (!item_description) {
    ...
    item_categorie += '<span class="extraOptions"><select id="selectOption'+selectName+postid+'"><option value="artikel">2.Kies utm content</option><optgroup label="Headline"><option value="headlineadvactueel">headlineadvactueel</option><option value="headlineadvthema">headlineadvthema</option></optgroup><optgroup label="Afb en tekst"><option value="advactueel">advactueel</option><option value="advthema">advthema</option></optgroup><optgroup label="Campagnebalk"><option value="adv">adv</option></optgroup><optgroup label="Agenda"><option value="agenda">agenda</option></optgroup></select></span>';  
    item_categorie += '<span class="extraOptionsLabel"><select id="selectOptionLabel'+selectName+postid+'"><option value="">3.Kies label</option><option value="themavdweek">Thema vd week</option><option value="adv">Adv</option><option value="tip">TIP</option></select></span>';
    item_categorie += '</div>';
    item_categorie += '<div style="background: white;"><span class="postTitle">'+item_title+'</span><span class="w100"></span></div>';
